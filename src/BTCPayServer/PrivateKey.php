...
use BTCPayServer\Util\Secp256k1;
use BTCPayServer\Util\Util;
use BTCPayServer\Util\SecureRandom;
...
class PrivateKey extends Key
{
     ...
     *
     * @return \BTCPayServer\PrivateKey
     */
    public function generate()
    {
        ...
        do {
            $privateKey = \BTCPayServer\Util\SecureRandom::generateRandom(32);
