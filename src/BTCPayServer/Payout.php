...
class Payout implements PayoutInterface
{
    ...
    /**
     * Set the batch ID as assigned from btcpayserver.
     *
     * @param $id
     * @return $this
     */
    ...
    /**
     * Set Account Id - BTCPayServers account ID for the payout.
     *
     * @param $id
     * @return $this
     */
    ...
    /**
     * Set the Bitcoin amount for this payout, once set by BTCPayServer.
     * @param $amount
     * @return $this
     */
    ...
    /**
     * Set Response Token - returned by BTCPayServer when payout request is created
     *
     * @param $responseToken
     * @return $this
     */
